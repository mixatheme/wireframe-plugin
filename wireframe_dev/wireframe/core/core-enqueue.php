...
if ( ! class_exists( 'MixaTheme\Wireframe\Plugin\Core_Enqueue' ) ) :
	/**
	 * Core_Enqueue core Wireframe class for wiring styles & scripts.
	 *
	 * @since 0.1.0 Wireframe
	...
	final class Core_Enqueue implements Core_Enqueue_Interface {
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @var    string $_prefix The prefix for strings.
		 */
		private $_prefix;
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @var    array $_styles An array of stylesheets to enqueue.
		 */
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @var    array $_scripts An array of scripts to enqueue.
		 */
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @var    bool $_mediamodal Enables to the Media Modal script.
		 */
		 ...
		 * @since  0.1.0 Wireframe
		 * @since  0.1.0 Wireframe_Theme
		 * @var    bool $_stylecss Enables the `style.css` stylesheet.
		 */
		 ...
		 * @since  0.1.0 Wireframe
		 * @since  0.1.0 Wireframe_Theme
		 * @var    bool $_commentjs Enables the Comment Reply script.
		 */
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @return string The prefix for strings.
		 */
		 ...
		 * @since  0.1.0 Wireframe_Theme
		 * @since  0.1.0 Wireframe_Plugin
		 * @return string An array of stylesheets to enqueue.
		 */
		 ...
		 * @since 0.1.0 Wireframe_Theme
		 * @since 0.1.0 Wireframe_Plugin
		 * @return string Enables the Media Modal script.
		 */
		public function get_mediamodal() {
			if ( isset( $this->_mediamodal ) ) {
		 ...
		 * @since 0.1.0 Wireframe_Theme
		 * @since 0.1.0 Wireframe_Plugin
		 * @return string Enables the `style.css` stylesheet.
		 */
		public function get_stylecss() {
			if ( isset( $this->_stylecss ) ) {
		...
		public function get_commentjs() {
			if ( isset( $this->_commentjs ) ) {
				return $this->_commentjs;
			}
		}
