<?php
/**
 * Module_Shortcode config file for Wireframe themes & plugins.
 *
 * PHP version 5.6.0
 *
...
function wireframe_plugin_cfg_shortcode() {
	 ...
	 * Wired.
	 *
	 * Wires the Module_Shortcode actions & filters at runtime.
	 *
	 * Enable this configuration file:
	 *
	 * 		1. In this config file, set: $wired = true.
	 * 		2. In this config file, modify any default data you need.
	 * 		3. In `config-controller.php` instantiate Module_Shortcode.
	 * 		4. In `config-controller.php` pass this config into Module_Shortcode.
	 *
	 * @since 0.1.0 Wireframe
	 * @since 0.1.0 Wireframe_Plugin
